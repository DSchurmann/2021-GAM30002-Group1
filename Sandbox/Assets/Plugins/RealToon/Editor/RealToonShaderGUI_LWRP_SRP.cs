...
public class RealToonShaderGUI_LWRP_SRP : ShaderGUI
{
    ...
    //MaterialProperty _ReduceShadowPointLight; //Temporarily Removed
    //MaterialProperty _PointLightSVD; //Temporarily Removed
    ...
    MaterialProperty _N_F_DCS;
    MaterialProperty _N_F_EAL;
    ...
    string[] TOTIPS =
    {
        ...
        //Vertex Color Red Affect Outline Width [39] [Outline]
        "'Vertex Color Red' will affect the Outline Width.\n\nThis will not work if the Outline main width value is 0." ,
        ...
        //Vertex Color Blue Control Smooth Object Normal [72]
        "'Vertex color Blue' controls the amount of smooth object normal." ,
        ...
        //No Light On Backface. [16] [Default and Tesselation Transparency Only]
        ...
        //Disable Cast Shadow [119] [Default and Tesselation Transparency & Refraction Only]
        "Disable object cast shadow." ,

        //ZWrite [120] [Default and Tesselation Transparency & Refraction Only]
        ...
        //Reduce Outline Backface [122] [Outline] [Default and Tesselation Transparency Only]
        "Reduce outline backface." ,

        //Outline Z Position In Camera [123] [Outline]
        "Adjust the outline Z position in camera space." ,

        //RealTime Shadow Intensity [124] [Shadow]
        "Adjust the realtime shadow intensity." ,

        //Self Shadow Intensity [125] [Shadow] Default and Tesselation Transparency & Refraction Only]
        "Adjust the 'Self Shadow' shadow intensity." ,

        //Self Shadow & RealTime Shadow Intensity [126][Shadow] [Default and Tesselation Transparency & Refraction Only]
        "Adjust the 'Self Shadow' and realtime shadow intensity." ,

        //Self Shadow Color [127] [Shadow] Default and Tesselation Transparency & Refraction Only]
        "'Self Shadow' color." ,

        //Self Shadow Color Power [128] [Shadow] Default and Tesselation Transparency & Refraction Only]
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        {
            case "Lightweight Render Pipeline/RealToon/Version 5/Default/Default":
                shader_name = "default_d";
                shader_type = "LWRP - Default";
                break;
            case "Lightweight Render Pipeline/RealToon/Version 5/Default/Fade Transparency":
                shader_name = "default_ft";
                shader_type = "LWRP - Fade Transperancy"; 
                break;
        ...
        EditorGUILayout.LabelField("RealToon 5.0.6", EditorStyles.boldLabel);
        ...
        if (ShowUI == true)
        {
            ...
            if (shader_name == "default_d" || shader_name == "tessellation_d" || shader_name == "default_ft" || shader_name == "tessellation_ft")
            {
                if (_N_F_O.floatValue == 1)
                {
                    ...
                    if (ShowOutline)
                    {
                        ...
                        materialEditor.ShaderProperty(_OutlineWidth, new GUIContent("Outline Width", TOTIPS[27]));

                        materialEditor.ShaderProperty(_OutlineWidthControl, new GUIContent(_OutlineWidthControl.displayName, TOTIPS[28]));

                        if (shader_name == "default_ft" || shader_name == "tessellation_ft")
                        {
                            materialEditor.ShaderProperty(_ReduceOutlineBackFace, new GUIContent(_ReduceOutlineBackFace.displayName, TOTIPS[122]));
                        }
                        ...
                        GUILayout.Space(10);
                        materialEditor.ShaderProperty(_VertexColorRedAffectOutlineWitdh, new GUIContent(_VertexColorRedAffectOutlineWitdh.displayName, TOTIPS[39]));
            ...
            if (ShowShadow)
            {
                ...
                if (shader_name == "default_d" || shader_name == "tessellation_d")
                {
                    ...
                    {
                        GUILayout.Space(10);
                        materialEditor.ShaderProperty(_ShadowHardness, new GUIContent(_ShadowHardness.displayName, TOTIPS[67]));
                    }
                ...
                if (_N_F_SS.floatValue == 1)
                {
                    ...
                    if (_N_F_SS.floatValue == 1)
                    {
                        ...
                        if (shader_name == "default_ft" || shader_name == "tessellation_ft" || shader_name == "default_ref" || shader_name == "tessellation_ref")
                        {
                            materialEditor.ShaderProperty(_SelfShadowIntensity, new GUIContent(_SelfShadowIntensity.displayName, TOTIPS[125]));
                        }
                        ...
                        {
                            materialEditor.ShaderProperty(_SelfShadowColor, new GUIContent(_SelfShadowColor.displayName, TOTIPS[127]));
                            materialEditor.ShaderProperty(_SelfShadowColorPower, new GUIContent(_SelfShadowColorPower.displayName, TOTIPS[128]));
                        }
                ...
                if (_N_F_SON.floatValue == 1)
                {
                    ...
                    if (_N_F_SON.floatValue == 1)
                    {
                        ...
                        materialEditor.ShaderProperty(_VertexColorBlueControlSmoothObjectNormal, new GUIContent(_VertexColorBlueControlSmoothObjectNormal.displayName, TOTIPS[72]));
            ...
            if (ShowLighting)
            {
                ...
                GUILayout.Space(10);
                materialEditor.ShaderProperty(_DirectionalLightIntensity, new GUIContent(_DirectionalLightIntensity.displayName, TOTIPS[96]));
